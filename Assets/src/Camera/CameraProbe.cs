...
public class CameraProbe : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        goalPlanar.y = 0;
        posPlanar.y=0;
        float planarDist = Vector3.Distance(goalPlanar, posPlanar);
        Vector3 newPos = Vector3.Lerp(posPlanar,goalPlanar, hspeed*Time.deltaTime/planarDist);
